...
public class BTMainActivity extends AppCompatActivity {
            ...
            mPairedBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pairedDevices == null || pairedDevices.size() == 0) {
                        ...
                        Intent intent = new Intent(BTMainActivity.this, DeviceListActivity.class);
    ...
    private void showEnabled() {
        ...
        mStatusTv.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
                ...
                if (asset != null && !accessToken.isEmpty() && clientContact != null) {
                    newIntent.putExtra("asset", asset);
                    newIntent.putExtra("clientContact", clientContact);
